...
@immutable
class AuthorsTextFieldTheme extends ThemeExtension<AuthorsTextFieldTheme> {
  const AuthorsTextFieldTheme({
    this.border,
    this.enabledBorder,
    this.focusedBorder,
    this.errorBorder,
  ...
  @override
  ThemeExtension<AuthorsTextFieldTheme> copyWith({
    InputBorder? border,
  ...
  @override
  ThemeExtension<AuthorsTextFieldTheme> lerp(
    covariant ThemeExtension<AuthorsTextFieldTheme>? other,
    double t,
  ) {
    if (other is! AuthorsTextFieldTheme) {
      return this;
    }
  ...
  static AuthorsTextFieldTheme of(BuildContext context) {
    return Theme.of(context).extension<AuthorsTextFieldTheme>()!;
  }
}
