import 'package:authors/authors_ui_foundations/lib/src/utils/font_specs.dart';
import 'package:flutter/material.dart';

@immutable
class AuthorsTextTheme extends ThemeExtension<AuthorsTextTheme> {
  AuthorsTextTheme({required Color textColor, required String fontFamily})
  ...
  @override
  ThemeExtension<AuthorsTextTheme> copyWith({
    TextStyle? button,
  ...
  @override
  AuthorsTextTheme lerp(
    covariant ThemeExtension<AuthorsTextTheme>? other,
    double t,
  ) {
    if (other is! AuthorsTextTheme) {
      return this;
    }
    ...
    return AuthorsTextTheme._(
      ...
      headline3Regular:
          TextStyle.lerp(other.headline3Regular, headline3Regular, t)!,
      ...
      headline3SemiBold:
          TextStyle.lerp(other.headline3SemiBold, headline3SemiBold, t)!,
      ...
      headline5Regular:
          TextStyle.lerp(other.headline5Regular, headline5Regular, t)!,
      ...
      headline5SemiBold:
          TextStyle.lerp(other.headline5SemiBold, headline5SemiBold, t)!,
      headline2SemiBold:
          TextStyle.lerp(other.headline2SemiBold, headline2SemiBold, t)!,
      headline1Regular:
          TextStyle.lerp(other.headline1Regular, headline1Regular, t)!,
    );
  }

  static AuthorsTextTheme of(BuildContext context) {
    return Theme.of(context).extension<AuthorsTextTheme>()!;
  }
}
